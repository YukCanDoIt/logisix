...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ExceptionResponse> apiException(final ApiException e) {
  ...
  public ExceptionResponse httpRequestMethodNotSupportedException(
  ...
  public ExceptionResponse missingServletRequestParameter(
  ...
  public ExceptionResponse methodArgumentNotValidException(
    ...
    log.error(ERROR_LOG, e.getBindingResult().getTarget(),
